...
# =============================================================================
# EMBEDDING — dispatch theo EMBEDDING_PROVIDER, dùng chung cho Task 4/5
# =============================================================================

_st_model = None  # cache singleton, tránh load lại model mỗi lần gọi
...
def embed_texts(texts: list[str]) -> list[list[float]]:
    """Embed danh sách text theo EMBEDDING_PROVIDER (mặc định: sentence_transformers)."""
...
def get_collection():
    """Trả về ChromaDB collection dùng chung cho Task 4/5/6/9."""
    import chromadb
