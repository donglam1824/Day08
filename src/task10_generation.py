...
def generate_with_citation(query: str, top_k: int = TOP_K) -> dict:
    ...
    # If base_url is not None but api_key is, OpenAI client might complain if we aren't careful, 
    # but the provided snippet passes base_url directly. Let's use the provided code.
